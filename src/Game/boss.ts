...
export function bossFightSequence(user: User): void {
  if (
    user.getCurrentRoom === 'Great Room' &&
    user.getInventory.length === gameDetails.gameItems.length
  ) {
    console.log(
      chalk.blue(`
    ...
    console.log(
      chalk.blue(
        'You lose. Los notices your lack of confidence, and attacks your heart before remembering you have one.',
      ),
    );
  }
}
